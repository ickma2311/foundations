...
**Example**: In a deep network with 1000-dimensional input ($m = 1000$), the standard deviation would be $\frac{1}{\sqrt{1000}} \approx 0.0316$, which can lead to extremely small activations in early training.
