...
*Figure: Different data types and tasks require different architectural priors - the success of an architecture depends on how well its built-in assumptions match the structure of the problem.*
